  ...
  return (
    <div>
      <Navbar />
        <header>
          <div>
              <img src={lorawanCover} alt="Protocolo de comunicación LoRaWAN" className="banner1"/>
          </div>
          <div className="texto_banner1">
              <p>LoRaWAN es un protocolo de red que usa la tecnología LoRa, para redes de baja potencia y área amplia, LPWAN (Low Power Wide Area Network) empleado para comunicar y administrar dispositivos LoRa. El protocolo LoRaWAN se compone de gateways y nodos:
              gateways (antenas): son los encargados de recibir y enviar información a los nodos.
              nodos (dispositivos): son los dispositivos finales que envían y reciben información hacia el gateway.</p>
          </div>         
        </header>
        <main>
        ...
        <div className="contenedor_lorawan">
          ...
          <div className="medicionlorawan">
            ...
            <p>Los medidores con indicación análoga, están preequipados para instalar un módulo de comunicación, se clasifican en tecnología AMR (Automated meter reading).
              ...
              Los medidores con indicación digital, incorporan 8 alarmas antifraude, puerto de comunicación para dispositivo IoT (Sigfox por el momento).</p>
            <br />
